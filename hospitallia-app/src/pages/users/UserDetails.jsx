  ...
  return (
    <div className="max-w-lg mx-auto p-6">
      ...
      <div className="bg-white dark:bg-gray-800 p-4 rounded shadow">
        ...
        <div><strong>Height:</strong> {user.height ? `${user.height} cm` : ""}</div>
        <div><strong>Weight:</strong> {user.weight ? `${user.weight} kg` : ""}</div>
        <div><strong>Date of Birth:</strong> {user.dob}</div>
        <div><strong>Gender:</strong> {user.gender}</div>
        <div><strong>Emergency Contact:</strong> {user.emergencyContact}</div>
        <div><strong>Insurance Number:</strong> {user.insuranceNumber}</div>
        <div><strong>Allergies:</strong> {user.allergies}</div>
